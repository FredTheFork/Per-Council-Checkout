...
add_action('wp_enqueue_scripts', function() {
    wp_enqueue_style('pi-frontend-css', plugin_dir_url(__FILE__) . '../assets/frontend.css', [], '3.2');
    ...
    wp_enqueue_script('pi-frontend-js', plugin_dir_url(__FILE__) . '../assets/frontend.js', ['jquery'], '3.2', true);
